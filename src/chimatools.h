...
CHIMADEF chima_return chima_load_image(chima_context chima,
...
CHIMADEF chima_return chima_load_anim(chima_context chima,
...
CHIMADEF chima_return chima_create_spritesheet(chima_context chima,
